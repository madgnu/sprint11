 ...
 */
  ...
  * Не дробите пожалуйста на много различных файлов. Достаточно 2 файла, в текущем проекте(1 логика, 2 данные). 
  * В следующем спринте это будет оправданно, но только в рамках одного класса.
  * 
  */